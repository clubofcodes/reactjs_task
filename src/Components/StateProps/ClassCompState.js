...
class ClassCompState extends Component {
    ...
    increment = () => {
        ...
        console.log('Before Updated Count Value: ', this.state.count);
        ...
        this.setState(
            (prevState) => {
                console.log('Previous state Old Count: ', prevState.count);
                return { count: prevState.count + 1 }
            },
            () => console.log('Updated New Count: ', this.state.count)
        );
    }
